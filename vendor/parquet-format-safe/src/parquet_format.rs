...
#[derive(Default)]
struct ColumnMetaDataFields {
  f_1: Option<Type>,
  f_2: Option<Vec<Encoding>>,
  f_3: Option<Vec<String>>,
  f_4: Option<CompressionCodec>,
  f_5: Option<i64>,
  f_6: Option<i64>,
  f_7: Option<i64>,
  f_8: Option<Vec<KeyValue>>,
  f_9: Option<i64>,
  f_10: Option<i64>,
  f_11: Option<i64>,
  f_12: Option<Statistics>,
  f_13: Option<Vec<PageEncodingStats>>,
  f_14: Option<i64>,
}

impl ColumnMetaDataFields {
  #[inline(never)]
  fn read_first<T: TInputProtocol>(&mut self, field_id: i16, field_type: TType, i_prot: &mut T) -> thrift::Result<()> {
    match field_id {
      1 => self.f_1 = Some(Type::read_from_in_protocol(i_prot)?),
      2 => self.f_2 = Some(i_prot.read_list()?),
      3 => self.f_3 = Some(i_prot.read_list()?),
      4 => self.f_4 = Some(CompressionCodec::read_from_in_protocol(i_prot)?),
      5 => self.f_5 = Some(i_prot.read_i64()?),
      6 => self.f_6 = Some(i_prot.read_i64()?),
      7 => self.f_7 = Some(i_prot.read_i64()?),
      _ => i_prot.skip(field_type)?,
    }
    Ok(())
  }

  #[inline(never)]
  fn read_second<T: TInputProtocol>(&mut self, field_id: i16, field_type: TType, i_prot: &mut T) -> thrift::Result<()> {
    match field_id {
      8 => self.f_8 = Some(i_prot.read_list()?),
      9 => self.f_9 = Some(i_prot.read_i64()?),
      10 => self.f_10 = Some(i_prot.read_i64()?),
      11 => self.f_11 = Some(i_prot.read_i64()?),
      12 => self.f_12 = Some(Statistics::read_from_in_protocol(i_prot)?),
      13 => self.f_13 = Some(i_prot.read_list()?),
      14 => self.f_14 = Some(i_prot.read_i64()?),
      _ => i_prot.skip(field_type)?,
    }
    Ok(())
  }
  ...
  #[inline(never)]
  fn finish(self) -> thrift::Result<ColumnMetaData> {
    verify_required_field_exists("ColumnMetaData.type_", &self.f_1)?;
    verify_required_field_exists("ColumnMetaData.encodings", &self.f_2)?;
    verify_required_field_exists("ColumnMetaData.path_in_schema", &self.f_3)?;
    verify_required_field_exists("ColumnMetaData.codec", &self.f_4)?;
    verify_required_field_exists("ColumnMetaData.num_values", &self.f_5)?;
    verify_required_field_exists("ColumnMetaData.total_uncompressed_size", &self.f_6)?;
    verify_required_field_exists("ColumnMetaData.total_compressed_size", &self.f_7)?;
    verify_required_field_exists("ColumnMetaData.data_page_offset", &self.f_9)?;
    Ok(ColumnMetaData {
      type_: self.f_1.expect("auto-generated code should have checked for presence of required fields"),
      encodings: self.f_2.expect("auto-generated code should have checked for presence of required fields"),
      path_in_schema: self.f_3.expect("auto-generated code should have checked for presence of required fields"),
      codec: self.f_4.expect("auto-generated code should have checked for presence of required fields"),
      num_values: self.f_5.expect("auto-generated code should have checked for presence of required fields"),
      total_uncompressed_size: self.f_6.expect("auto-generated code should have checked for presence of required fields"),
      total_compressed_size: self.f_7.expect("auto-generated code should have checked for presence of required fields"),
      key_value_metadata: self.f_8,
      data_page_offset: self.f_9.expect("auto-generated code should have checked for presence of required fields"),
      index_page_offset: self.f_10,
      dictionary_page_offset: self.f_11,
      statistics: self.f_12,
      encoding_stats: self.f_13,
      bloom_filter_offset: self.f_14,
    })
  }
}
...
impl ReadThrift for ColumnMetaData {
  ...
  fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<ColumnMetaData> {
    i_prot.read_struct_begin()?;
    let mut fields = ColumnMetaDataFields::default();
    loop {
      let field_ident = i_prot.read_field_begin()?;
      if field_ident.field_type == TType::Stop {
        break;
      ...
      let field_id = field_id(&field_ident)?;
      if field_id <= 7 {
        fields.read_first(field_id, field_ident.field_type, i_prot)?;
      } else {
        fields.read_second(field_id, field_ident.field_type, i_prot)?;
      }
      i_prot.read_field_end()?;
    }
    i_prot.read_struct_end()?;
